...
app.get("/",function(req,res){
  connection.query('SELECT counter from tests LIMIT 1', function(err, rows, fields) {
    if (!err) {
      res.send('<span style="font-family: Arial; font-size: 30px;">I\'m running on <b>NON MASTER BRANCH</b> and <b>' + os.hostname() + '</b> and so far I\'v had <b>' + rows[0].counter + '</b> hits</span>');
